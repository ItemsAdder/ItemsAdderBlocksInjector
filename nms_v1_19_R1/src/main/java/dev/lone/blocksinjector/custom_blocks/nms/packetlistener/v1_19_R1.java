 ...
 */
public class v1_19_R1 extends AbstractPacketListener
{
    ChunkSectionType1_18 viaSectionIo = new ChunkSectionType1_18(Block.BLOCK_STATE_REGISTRY.size(), Registry.BIOME_SOURCE.size());
        ...
        try
        {
            ...
            else if (e.getPacketType() == PacketType.Play.Server.WORLD_PARTICLES)
            {
                ...
                if (particlesPacket.getParticle() instanceof BlockParticleOption)
                {
                    ...
                    if (dev.lone.blocksinjector.custom_blocks.nms.blocksmanager.v1_19_R1.inst.REGISTRY.contains(blockParticleOption.getState().getBlock()))
                    {
                        e.setCancelled(true);
