...
public class v1_21_1 extends CustomBlocksInjector<Block, BlockState, ClientboundLevelChunkPacketData>
{
    public v1_21_1()
    {
        try
    ...
    public void registerListener()
    {
        if(packet == null)
        {
            packet = new dev.lone.blocksinjector.custom_blocks.nms.packetlistener.v1_21_1(Main.inst);
            ...
            else
            {
                try
                {
                    ...
                    Registry.register(
                            ...
                            ResourceLocation.fromNamespaceAndPath(cached.namespace, cached.key),
                            internalBlock
                    );
