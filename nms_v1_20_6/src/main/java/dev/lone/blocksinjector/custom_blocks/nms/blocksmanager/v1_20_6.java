...
public class v1_20_6 extends CustomBlocksInjector<Block, BlockState, ClientboundLevelChunkPacketData>
{
    public v1_20_6()
    {
        try
    ...
    public void registerListener()
    {
        if(packet == null)
        {
            packet = new dev.lone.blocksinjector.custom_blocks.nms.packetlistener.v1_20_6(Main.inst);
