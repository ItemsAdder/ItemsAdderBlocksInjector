 ...
 */
public class v1_20_6 extends AbstractPacketListener
{
        ...
        try
        {
            ...
            else if (e.getPacketType() == PacketType.Play.Server.WORLD_PARTICLES)
            {
                ...
                if (particlesPacket.getParticle() instanceof BlockParticleOption)
                {
                    ...
                    if (dev.lone.blocksinjector.custom_blocks.nms.blocksmanager.v1_20_6.inst.REGISTRY.contains(blockParticleOption.getState().getBlock()))
                    {
                        e.setCancelled(true);
