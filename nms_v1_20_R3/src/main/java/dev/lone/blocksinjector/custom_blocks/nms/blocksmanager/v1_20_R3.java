...
public class v1_20_R3 extends CustomBlocksInjector<Block, BlockState, ClientboundLevelChunkPacketData>
{
    public v1_20_R3()
    {
        try
    ...
    public void registerListener()
    {
        if(packet == null)
        {
            packet = new dev.lone.blocksinjector.custom_blocks.nms.packetlistener.v1_20_R3(Main.inst);
                ...
                try
                {
                    ...
                    switch (cached.type)
                    {
                        ...
                        case REAL_TRANSPARENT:
                            properties = BlockBehaviour.Properties.ofFullCopy(Blocks.END_ROD).lightLevel(value -> 0);
                            break;
                        case REAL_WIRE:
