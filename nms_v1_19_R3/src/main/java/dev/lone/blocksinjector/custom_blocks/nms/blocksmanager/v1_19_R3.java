...
public class v1_19_R3 extends CustomBlocksInjector<Block, BlockState, ClientboundLevelChunkPacketData>
{
    public v1_19_R3()
    {
        try
    ...
    public void registerListener()
    {
        if(packet == null)
        {
            packet = new dev.lone.blocksinjector.custom_blocks.nms.packetlistener.v1_19_R3(Main.inst);
